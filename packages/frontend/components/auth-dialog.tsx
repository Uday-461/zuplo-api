  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] bg-slate-900 border-slate-800">
        <DialogHeader>
          <DialogTitle className="text-white">Welcome to MCP Collection</DialogTitle>
        ...
        <Tabs defaultValue="signin" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-slate-800">
            <TabsTrigger value="signin" className="data-[state=active]:bg-slate-700 text-slate-300">
              Sign In
            </TabsTrigger>
          ...
          <TabsContent value="signup">
            <Card className="bg-slate-900 border-slate-800">
              <CardHeader>
                ...
                <CardDescription className="text-slate-400">Sign up for a free account to get started.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <Button
                  onClick={handleGoogleAuth}
